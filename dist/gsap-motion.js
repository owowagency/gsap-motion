...
function Ja(t, e, r) {
  ...
  function w(k) {
    return p = k, l = setTimeout(C, e), h ? o(k) : a;
  }
  function M(k) {
  ...
  function he(k) {
    return l = void 0, g && n ? o(k) : (n = i = void 0, a);
  }
  function U() {
...
var tt, Hi, vt, pn, hn, Gn, ll, Sn, gr, al, en, Rt, ul, cl = function() {
  ...
  var i = e, s = e, a = mr(), l = a, c = r || 50, p = Math.max(500, c * 3), h = function(w, M) {
    ...
    var M = l, $ = s, C = mr();
    return (w || w === 0) && w !== i && h(w), a === l || C - l > p ? 0 : (i + (n ? $ : -$)) / ((n ? C : a) - M) * 1e3;
  };
  return {
    update: h,
    reset: y,
...
var Fe = /* @__PURE__ */ function() {
  ...
  return e.init = function(n) {
    ...
    var i = n.tolerance, s = n.dragMinimum, a = n.type, l = n.target, c = n.lineHeight, p = n.debounce, h = n.preventDefault, y = n.onStop, g = n.onStopDelay, o = n.ignore, w = n.wheelSpeed, M = n.event, $ = n.onDragStart, C = n.onDragEnd, he = n.onDrag, U = n.onPress, X = n.onRelease, D = n.onRight, k = n.onLeft, E = n.onUp, I = n.onDown, me = n.onChangeX, B = n.onChangeY, O = n.onChange, R = n.onToggleX, z = n.onToggleY, ee = n.onHover, _e = n.onHoverEnd, ae = n.onMove, Y = n.ignoreCheck, xe = n.isNormalizer, Pe = n.onGestureStart, m = n.onGestureEnd, G = n.onWheel, de = n.onEnable, ve = n.onDisable, ue = n.onClick, pt = n.scrollSpeed, Z = n.capture, Ce = n.allowClicks, le = n.lockAxis, qt = n.onLockAxis;
    ...
    var ke, Re, H, Ee, pe, Q, Ue, v = this, Ne = 0, ye = 0, wt = vn(l, ut), kt = vn(l, Ge), Be = wt(), qe = kt(), Ft = ~a.indexOf("touch") && !~a.indexOf("pointer") && Rt[0] === "pointerdown", Ot = _r(l), fe = l.ownerDocument || pn, Ae = [0, 0, 0], $e = [0, 0, 0], yn = 0, We = function() {
      ...
      if (!bt(_, 1)) {
        ...
        !d && f && (v._vx.reset(), v._vy.reset(), h && Ce && tt.delayedCall(0.08, function() {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var N, Fn, ie, Me, It, Oe, hl, ai, ui, Hn, jr, Xr, rt, wi, qi, lt, ds, ps, $n, gl, Di, ml, gt, _l, vl, yl, fn, Qi, ho, Pi, zr = 1, at = Date.now, Ci = at(), Ct = 0, sr = 0, hu = function t() {
  ...
  var p = s.startColor, h = s.endColor, y = s.fontSize, g = s.indent, o = s.fontWeight, w = Me.createElement("div"), M = Nn(n) || _n(n, "pinType") === "fixed", $ = e.indexOf("scroller") !== -1, C = M ? Oe : n, he = e.indexOf("start") !== -1, U = he ? p : h, X = "border-color:" + U + ";font-size:" + y + ";color:" + U + ";font-weight:" + o + ";pointer-events:none;white-space:nowrap;font-family:sans-serif,Arial;z-index:1000;padding:4px 8px;border-width:0;border-style:solid;";
  ...
  return at() - Ct > 34 && (Pr || (Pr = requestAnimationFrame(an)));
}, Xn = function() {
  (!gt || !gt.isPressed || gt.startX > Oe.clientWidth) && (ne.cache++, gt ? Pr || (Pr = requestAnimationFrame(an)) : an(), Ct || Ln("scrollStart"), Ct = at());
}, Oi = function() {
  ...
  }), Pl(ho, 1), ai.pause(), Cn++, _t = 2, an(2), J.forEach(function(i) {
  ...
  if (o && o.seek(0), ar(e))
    o && (e = N.utils.mapRange(o.scrollTrigger.start, o.scrollTrigger.end, 0, g, e)), l && Jr(l, n, i, !0);
  else {
    ct(r) && (r = r(c));
    var he = (e || "0").split(" "), U, X, D, k;
    C = dt(r) || Oe, U = Jt(C) || {}, (!U || !U.left && !U.top) && Xt(C).display === "none" && (k = C.style.display, C.style.display = "block", U = Jt(C), k ? C.style.display = k : C.style.removeProperty("display")), X = Zr(he[0], U[i.d]), D = Zr(he[1] || "0", n), e = U[i.p] - p[i.p] - h + X + s - D, l && Jr(l, D, i, n - D < 20 || l._isStart && D > 20), n -= n - D;
  }
  if (a) {
  ...
  return o && C && (M = Jt(C), o.seek(g), $ = Jt(C), o._caScrollDist = M[i.p] - $[i.p], e = e / o._caScrollDist * g), o && o.seek(w), o ? e : Math.round(e);
  ...
  return e.init = function(n, i) {
    ...
    m.previous = function() {
      ...
      if (!((rt || !m.enabled) && !x)) {
        ...
        for (var b = de(), S = ve(), T = E ? E.duration() : gn(R, B), A = ye <= 0.01, L = 0, W = 0, j = n.end, te = n.endTrigger || g, ce = n.start || (n.start === 0 || !g ? 0 : o ? "0 0" : "0 100%"), be = m.pinnedContainer = n.pinnedContainer && dt(n.pinnedContainer), Te = g && Math.max(0, J.indexOf(m)) || 0, re = Te, V, Xe, Qe, wn, ze, je, Wt, bi, Eo, tr, Ht; re--; )
          je = J[re], je.end || je.refresh(0, 1) || (rt = m), Wt = je.pin, Wt && (Wt === g || Wt === o || Wt === be) && !je.isReverted && (tr || (tr = []), tr.unshift(je), je.revert(!0, !0)), je !== J[re] && (Te--, re--);
        for (ct(ce) && (ce = ce(m)), H = xs(ce, g, b, B, Z(), pe, Ue, m, S, Pe, _e, T, E) || (o ? -1e-3 : 0), ct(j) && (j = j(m)), At(j) && !j.indexOf("+=") && (~j.indexOf(" ") ? j = (At(ce) ? ce.split(" ")[0] : "") + j : (L = Zr(j.substr(2), b), j = At(ce) ? ce : (E ? N.utils.mapRange(0, E.duration(), E.scrollTrigger.start, E.scrollTrigger.end, H) : H) + L, te = g)), Ee = Math.max(H, xs(j || (te ? "100% 0" : T), te, b, B, Z() + L, Q, v, m, S, Pe, _e, T, E)) || -1e-3, ye = Ee - H || (H -= 0.01) && 1e-3, L = 0, re = Te; re--; )
          je = J[re], Wt = je.pin, Wt && je.start - je._pinPush <= H && !E && je.end > 0 && (V = je.end - je.start, (Wt === g && je.start - je._pinPush < H || Wt === be) && !ar(ce) && (L += V * (1 - je.progress)), Wt === o && (W += V));
...
q.batch = function(t, e) {
  var r = [], n = {}, i = e.interval || 0.016, s = e.batchMax || 1e9, a = function(p, h) {
    var y = [], g = [], o = N.delayedCall(i, function() {
      h(y, g), y = [], g = [];
    }).pause();
    return function(w) {
...
var Es = function(e, r, n, i) {
  ...
  var r = e, n = r.normalizeScrollX, i = r.momentum, s = r.allowNestedScroll, a = r.onRelease, l, c, p = dt(e.target) || It, h = N.core.globals().ScrollSmoother, y = h && h.get(), g = fn && (e.content && dt(e.content) || y && e.content !== !1 && !y.smooth() && y.content()), o = vn(p, Ge), w = vn(p, ut), M = 1, $ = (Fe.isTouch && ie.visualViewport ? ie.visualViewport.scale * ie.visualViewport.width : ie.outerWidth) / ie.innerWidth, C = 0, he = ct(i) ? function() {
    return i(l);
  } : function() {
    return i || 2.8;
    ...
    c = gn(p, Ge), I = Hn(fn ? 1 : 0, c), n && (E = Hn(0, gn(p, ut))), U = Cn;
  }, B = function() {
  ...
  return g && N.set(g, {
    ...
    X = !1;
    var Y = M;
    M = lr((ie.visualViewport && ie.visualViewport.scale || 1) / $), R.pause(), Y !== M && Ni(p, M > 1.01 ? !0 : n ? !1 : "x"), z = w(), ee = o(), me(), U = Cn;
    ...
    if (o.offset && B(), !xe)
      ...
      ne.cache++;
      var Pe = he(), m, G;
      n && (m = w(), G = m + Pe * 0.05 * -Y.velocityX / 0.227, Pe *= Es(w, m, G, gn(p, ut)), R.vars.scrollX = E(G)), m = o(), G = m + Pe * 0.05 * -Y.velocityY / 0.227, Pe *= Es(o, m, G, gn(p, Ge)), R.vars.scrollY = I(G), R.invalidate().duration(Pe).play(0.01), (fn && R.vars.scrollY >= c || m >= c - 1) && N.to({}, {
        onUpdate: ae,
        duration: Pe
      });
    }
    ...
    if (Cn !== U && me(), xe && n && w(E(m[2] === xe ? z + (Y.startX - Y.x) : w() + xe - m[1])), Pe) {
      o.offset && B();
  ...
  if (s.length || s.push(Ai(e, 1), Ai(e, 2), Ai(e, 3)), l = n ? ri : cr, n)
    ...
    if (h = y = 0, Ol)
      for (c = e.offsetParent, p = e; p && (p = p.parentNode) && p !== c && p.parentNode; )
        (kn.getComputedStyle(p)[Pt] + "").length > 4 && (h = p.offsetLeft, y = p.offsetTop, p = 0);
    ...
    p = l.style, p.top = e.offsetTop - y + "px", p.left = e.offsetLeft - h + "px", p[Pt] = g[Pt], p[eo] = g[eo], p.position = g.position === "fixed" ? "fixed" : "absolute", e.parentNode.appendChild(l);
  }
  return l;
...
function Tn(t, e, r, n) {
  if (!t || !t.parentNode || (tn || Rl(t)).documentElement === t)
    return new In();
  var i = Cu(t), s = wo(t), a = s ? Nl : Al, l = Lu(t, r), c = a[0].getBoundingClientRect(), p = a[1].getBoundingClientRect(), h = a[2].getBoundingClientRect(), y = l.parentNode, g = !n && Ru(t), o = new In((p.left - c.left) / 100, (p.top - c.top) / 100, (h.left - c.left) / 100, (h.top - c.top) / 100, c.left + (g ? 0 : Ou()), c.top + (g ? 0 : ku()));
...
var se, we, yt, zt, nn, Ii, Zt, to, fr, mn, Ll, no, Cr, bo, dr, Nt, pr, ii, Il, ro, di = 0, Bl = function() {
  return typeof window < "u";
}, Xl = function() {
  ...
  r = mn(r)[0];
  var n = e.getBBox && e.ownerSVGElement, i = e.ownerDocument || yt, s, a, l, c, p, h, y, g, o, w, M, $, C;
  if (e === we)
  ...
  var n = document.createElement("div"), i = n.style, s = e.firstChild, a = 0, l = 0, c = e.scrollTop, p = e.scrollLeft, h = e.scrollWidth, y = e.scrollHeight, g = 0, o = 0, w = 0, M, $, C, he, U, X;
  Fl && r.force3D !== !1 ? (U = "translate3d(", X = "px,0px)") : Tr && (U = "translate(", X = "px)"), this.scrollTop = function(D, k) {
    ...
    D = -D, D < 0 ? (l = D - 0.5 | 0, D = 0) : D > o ? (l = D - o | 0, D = o) : l = 0, (l || I) && (this._skip || (i[Tr] = U + -l + "px," + -a + X), l + g >= 0 && (i.paddingRight = l + g + "px")), e.scrollLeft = D | 0, p = e.scrollLeft;
    ...
    c = e.scrollTop, p = e.scrollLeft, !(k && e.clientHeight === $ && n.offsetHeight === C && h === e.scrollWidth && y === e.scrollHeight && !D) && ((a || l) && (I = this.left(), me = this.top(), this.left(-e.scrollLeft), this.top(-e.scrollTop)), E = kr(e), (!k || D) && (i.display = "block", i.width = "auto", i.paddingRight = "0px", g = Math.max(0, e.scrollWidth - e.clientWidth), g && (g += parseFloat(E.paddingLeft) + (oo ? parseFloat(E.paddingRight) : 0))), i.display = "inline-block", i.position = "relative", i.overflow = "visible", i.verticalAlign = "top", i.boxSizing = "content-box", i.width = "100%", i.paddingRight = g + "px", oo && (i.paddingBottom = E.paddingBottom), M = e.clientWidth, $ = e.clientHeight, h = e.scrollWidth, y = e.scrollHeight, o = e.scrollWidth - M, w = e.scrollHeight - $, C = n.offsetHeight, i.display = "block", (I || me) && (this.left(I), this.top(me)));
  ...
  function e(r, n) {
    ...
    var s = (n.type || "x,y").toLowerCase(), a = ~s.indexOf("x") || ~s.indexOf("y"), l = s.indexOf("rotation") !== -1, c = l ? "rotation" : a ? "x" : "left", p = a ? "y" : "top", h = !!(~s.indexOf("x") || ~s.indexOf("left") || s === "scroll"), y = !!(~s.indexOf("y") || ~s.indexOf("top") || s === "scroll"), g = n.minimumMovement || 2, o = Ms(i), w = mn(n.trigger || n.handle || r), M = {}, $ = 0, C = !1, he = n.autoScrollMarginTop || 40, U = n.autoScrollMarginRight || 40, X = n.autoScrollMarginBottom || 40, D = n.autoScrollMarginLeft || 40, k = n.clickableTest || Gu, E = 0, I = r._gsap || se.core.getCache(r), me = Uu(r), B = function(u, _) {
      ...
      if (o.autoScroll && o.isDragging && (C || le)) {
        ...
        for (C = !1, Kt.scrollTop = we.pageYOffset != null ? we.pageYOffset : O.documentElement.scrollTop != null ? O.documentElement.scrollTop : O.body.scrollTop, Kt.scrollLeft = we.pageXOffset != null ? we.pageXOffset : O.documentElement.scrollLeft != null ? O.documentElement.scrollLeft : O.body.scrollLeft, S = o.pointerX - Kt.scrollLeft, T = o.pointerY - Kt.scrollTop; _ && !x; )
          x = Jn(_.parentNode), d = x ? Kt : _.parentNode, b = x ? {
            ...
            left: 0,
            top: 0
          } : d.getBoundingClientRect(), A = L = 0, y && (W = d._gsMaxScrollY - d.scrollTop, W < 0 ? L = W : T > b.bottom - X && W ? (C = !0, L = Math.min(W, f * (1 - Math.max(0, b.bottom - T) / X) | 0)) : T < b.top + he && d.scrollTop && (C = !0, L = -Math.min(d.scrollTop, f * (1 - Math.max(0, T - b.top) / he) | 0)), L && (d.scrollTop += L)), h && (W = d._gsMaxScrollX - d.scrollLeft, W < 0 ? A = W : S > b.right - U && W ? (C = !0, A = Math.min(W, f * (1 - Math.max(0, b.right - S) / U) | 0)) : S < b.left + D && d.scrollLeft && (C = !0, A = -Math.min(d.scrollLeft, f * (1 - Math.max(0, S - b.left) / D) | 0)), A && (d.scrollLeft += A)), x && (A || L) && (we.scrollTo(d.scrollLeft, d.scrollTop), Je(o.pointerX + A, o.pointerY + L)), _ = d;
      }
      if (le) {
        var j = o.x, te = o.y;
        l ? (o.deltaX = j - parseFloat(I.rotation), o.rotation = j, I.rotation = j + "deg", I.renderTransform(1, I)) : z ? (y && (o.deltaY = te - z.top(), z.top(te)), h && (o.deltaX = j - z.left(), z.left(j))) : a ? (y && (o.deltaY = te - parseFloat(I.y), I.y = te + "px"), h && (o.deltaX = j - parseFloat(I.x), I.x = j + "px"), I.renderTransform(1, I)) : (y && (o.deltaY = te - parseFloat(r.style.top || 0), r.style.top = te + "px"), h && (o.deltaX = j - parseFloat(r.style.left || 0), r.style.left = j + "px")), Pe && !u && !ye && (ye = !0, Le(o, "drag", "onDrag") === !1 && (h && (o.x -= o.deltaX), y && (o.y -= o.deltaY), P(!0)), ye = !1);
      }
      le = !1;
    }, Ae = function(u, _) {
      var f = o.x, d = o.y, x, b;
      ...
      a && (I.x = B(c, "px") + "px", I.y = B(p, "px") + "px", I.renderTransform()), Qt(!1), Mt.x = o.pointerX - _, Mt.y = o.pointerY - f, Q && Q.apply(Mt, Mt), ee = Mt.x, _e = Mt.y, le && (Je(o.pointerX, o.pointerY), fe(!0)), qe = Tn(r), z ? (We(), Y = z.top(), ae = z.left()) : (ht() ? (Ae(!0, !0), We()) : o.applyBounds(), l ? (d = r.ownerSVGElement ? [I.xOrigin - r.getBBox().x, I.yOrigin - r.getBBox().y] : (kr(r)[io] || "0 0").split(" "), Ce = o.rotationOrigin = Tn(r).apply({
        x: parseFloat(d[0]) || 0,
        y: parseFloat(d[1]) || 0
      }), Ae(!0, !0), x = o.pointerX - Ce.x - _, b = Ce.y - o.pointerY + f, ae = o.x, Y = o.y = Math.atan2(b, x) * Ds) : (Y = B(p, "px"), ae = B(c, "px"))), xe && u && (ae > G ? ae = G + (ae - G) / u : ae < de && (ae = de - (de - ae) / u), l || (Y > ve ? Y = ve + (Y - ve) / u : Y < ue && (Y = ue - (ue - Y) / u))), o.startX = ae = un(ae), o.startY = Y = un(Y);
    }, ht = function() {
      ...
      var f;
      if (!R || o.isPressed || !u || (u.type === "mousedown" || u.type === "pointerdown") && !_ && cn() - E < 30 && Cr[o.pointerEvent.type]) {
        Be && u && R && Tt(u);
        return;
      }
      ...
      if (v = !pe || h === y || o.vars.allowNativeTouchScrolling === !1 || o.vars.allowContextMenu && u && (u.ctrlKey || u.which > 2) ? !1 : h ? "y" : "x", Be = !v && !o.allowEventDefault, Be && (Tt(u), Ve(we, "touchforcechange", Tt)), u.changedTouches ? (u = pt = u.changedTouches[0], Z = u.identifier) : u.pointerId ? Z = u.pointerId : pt = Z = null, di++, Fu(fe), _e = o.pointerY = u.pageY, ee = o.pointerX = u.pageX, Le(o, "pressInit", "onPressInit"), (v || o.autoScroll) && Bi(r.parentNode), r.parentNode && o.autoScroll && !z && !l && r.parentNode._gsMaxScrollX && !Zt.parentNode && !r.getBBox && (Zt.style.width = r.parentNode.scrollWidth + "px", r.parentNode.appendChild(Zt)), St(), o.tween && o.tween.kill(), o.isThrowing = !1, se.killTweensOf(z || r, M, !0), z && se.killTweensOf(r, {
        scrollTo: 1
      ...
      if (o.pointerEvent = u, f = u.changedTouches, f) {
        ...
        return;
      if (pe && v && !Ne && (Mt.x = u.pageX - (me ? Kn(O) : 0), Mt.y = u.pageY - (me ? jn(O) : 0), Q && Q.apply(Mt, Mt), d = Mt.x, x = Mt.y, S = Math.abs(d - ee), T = Math.abs(x - _e), (S !== T && (S > g || T > g) || dr && v === Ne) && (Ne = S > T && h ? "x" : "y", v && Ne !== v && Ve(we, "touchforcechange", Tt), o.vars.lockAxisOnTouchScroll !== !1 && h && y && (o.lockedAxis = Ne === "x" ? "y" : "x", dn(o.vars.onLockAxis) && o.vars.onLockAxis.call(o, _)), dr && v === Ne))) {
        Se(_);
        return;
      }
      ...
      if (pe ? (Ye(pe, "touchend", P), Ye(pe, "touchmove", He), Ye(pe, "touchcancel", P), Ye(O, "touchstart", Rs)) : Ye(O, "mousemove", He), Ye(we, "touchforcechange", Tt), (!ii || !pe) && (Ye(O, "mouseup", P), u && u.target && Ye(u.target, "mouseup", P)), le = !1, d && ($ = Ps = cn(), o.isDragging = !1), Os(fe), Ee && !x) {
    ...
    return qt = e.get(r), qt && qt.kill(), i.startDrag = function(P, u) {
      ...
      var b = o.x, S = o.y;
      return Qt(!u), P ? o.applyBounds() : (le && _ && fe(!0), Ae(!0)), u && (Je(o.pointerX, o.pointerY), le && fe(!0)), o.isPressed && !u && (h && Math.abs(b - o.x) > 0.01 || y && Math.abs(S - o.y) > 0.01 && !l) && St(), o.autoScroll && (Bi(r.parentNode, o.isDragging), C = o.isDragging, fe(!0), As(r, nt), Ns(r, nt)), o;
    }, i.enable = function(P) {
      var u = {
        lazy: !0
      }, _, f, d;
      if (n.cursor !== !1 && (u.cursor = n.cursor || pr), se.utils.checkPrefix("touchCallout") && (u.touchCallout = "none"), P !== "soft") {
        for (Cs(w, h === y ? "none" : n.allowNativeTouchScrolling && r.scrollHeight === r.clientHeight == (r.scrollWidth === r.clientHeight) || n.allowEventDefault ? "manipulation" : h ? "pan-y" : "pan-x"), f = w.length; --f > -1; )
    ...
    }, n)), r.style.overflowY = y && !no ? "auto" : "hidden", r.style.overflowX = h && !no ? "auto" : "hidden", r = z.content), l ? M.rotation = 1 : (h && (M[c] = 1), y && (M[p] = 1)), I.force3D = "force3D" in n ? n.force3D : !0, Il(Ms(i)), i.enable(), i;
  }
  return e.register = function(n) {
    ...
    if (n === i)
      return !1;
    var a = Yn(n), l = Yn(i), c = a.top, p = a.left, h = a.right, y = a.bottom, g = a.width, o = a.height, w = l.left > h || l.right < p || l.top > y || l.bottom < c, M, $, C;
    return w || !s ? !w : (C = (s + "").indexOf("%") !== -1, s = parseFloat(s) || 0, M = {
      left: Math.max(p, l.left),
      top: Math.max(c, l.top)
    }, M.width = Math.min(h, l.right) - M.left, M.height = Math.min(y, l.bottom) - M.top, M.width < 0 || M.height < 0 ? !1 : C ? (s *= 0.01, $ = M.width * M.height, $ >= g * o * s || $ >= l.width * l.height * s) : M.width > s && M.height > s);
  }, e;
}(Qu);
$u(er.prototype, {
  pointerX: 0,
  ...
  constructor(e, r = {}, n = {}) {
    super(
      (i) => {
        ...
        ), C = F.utils.wrap(0, -h.width), he = F.utils.normalize(0, -h.width);
        ...
        const O = F.ticker.add(() => {
          ...
          k = F.getProperty(l, "x"), E = i.meta.speed * -U, I = (E - D) * B, me = C(k + I), $(me), (_e = (ee = i.meta).onUpdate) == null || _e.call(ee, he(me));
        });
...
function rc(t, e, r) {
  ...
  return (s) => {
    ...
    ), l = oc(s.dom, t), c = F.quickSetter(s.dom.outerContainer, "x", "px"), p = t.stopOnDrag ?? !0, h = ge(ju(1e3), c), y = Ku(0, -s.rects.innerRect.width), g = Zu(0, -s.rects.innerRect.width);
    ...
    const I = Yt(
      () => F.ticker.add(() => {
        ...
        C = F.getProperty(s.dom.outerContainer, "x"), C -= k, he = (t.speed ?? 1) * -o, U = E && p ? 0 : (he - M) * w, X = y(C + U + D), k = D, h(X), (O = e.onUpdate) == null || O.call(e, g(X));
      })
    );
    ge(
      a,

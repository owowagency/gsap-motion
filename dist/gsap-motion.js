import { fromEventPattern as ao, fromEvent as sn, noop as rs, debounceTime as co, Observable as ni, BehaviorSubject as ns, skip as is, map as ii } from "rxjs";
import F, { gsap as Ce } from "gsap";
const Sn = 1.70158, Tn = 0.7, ia = {
  /**
...
function po(e) {
  return ls(e, [], function(t, r) {
    return Array.isArray(r) ? Xn(r, function(n) {
      t.push(n);
    }) : t.push(r), t;
  });
}
...
function Di(e, t) {
  return Gn(bo(Object.keys(e), function(r) {
    var n = t(e[r]);
    return [
      r,
      n
...
function Ii(e, t) {
  return Gn(Ls(Object.keys(e), [], function(r, n) {
    var i = e[n];
    return t(n, i) ? Fs(r, [
      n,
      i
...
function To() {
  const e = _n(), t = So(!0), r = Ce.ticker.add(() => void t.setValue(!0)), n = it((i) => (o) => W(
    t.getValue(),
    Ut,
    fo(Boolean, () => {
      t.setValue(!1), i(o);
...
function Mo(e) {
  return (t = document) => (console.log({ root: t }), t == null ? void 0 : t.querySelector(e));
}
function Co(e, t) {
...
function bn(e) {
  return W(ho(1, Q(e)), po, tt(xo), an(ln));
}
var Fr = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Js(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var eu = "Expected a function", Wi = 0 / 0, tu = "[object Symbol]", ru = /^\s+|\s+$/g, nu = /^[-+]0x[0-9a-f]+$/i, iu = /^0b[01]+$/i, ou = /^0o[0-7]+$/i, su = parseInt, uu = typeof Fr == "object" && Fr && Fr.Object === Object && Fr, au = typeof self == "object" && self && self.Object === Object && self, cu = uu || au || Function("return this")(), lu = Object.prototype, fu = lu.toString, du = Math.max, gu = Math.min, xn = function() {
  return cu.Date.now();
};
function hu(e, t, r) {
  ...
  t = $i(t) || 0, An(r) && (m = !!r.leading, d = "maxWait" in r, o = d ? du($i(r.maxWait) || 0, t) : o, h = "trailing" in r ? !!r.trailing : h);
  function c(w) {
    var b = n, U = i;
...
const vu = /* @__PURE__ */ Js(_u), Oo = class {
  constructor(e, t = {}) {
    this.meta = {}, this.subscriptions = [], this.reset = vu(
      ...
      var i;
      return this.context = F.context(rs), [
        Q(t.enable) ?? !0,
...
function wn(e, t = {}) {
  const r = W(t, Q, Br(H(Ft, Q))), n = js(), i = So(un), o = new ns(e);
  o.subscribe(() => {
    i.getValue()(!1), i.setValue(e() ?? un);
  });
  const u = (d) => (h) => W(
    h.pipe(is((d == null ? void 0 : d.skip) ?? 0), co((d == null ? void 0 : d.debounce) ?? 300)).subscribe(
      H(
        Ut(`run effect from subscription: ${d == null ? void 0 : d.name}`),
        () => o.next(e)
      )
    ),
    Ut()
    ...
    tt(xo),
    an(ln),
    mo(yu("Observing the <body> for resizes may cause chain reactions."))
  ), f = W(
    s,
    cn(gs, "No elements to observe."),
    rt(n),
    rt(
      H(
  ...
  function m() {
    It(f, (d) => d.unsubscribe()), It(p, (d) => d.unsubscribe()), i.getValue()(!0);
  }
  return m;
}
const wu = To();
function yu(e) {
  return (t) => W(
    qn(t.tagName === "BODY", () => `Warning: ${e}`, Gs),
    Ft,
    Un(vn())
  );
}
...
const oa = it(() => {
  const e = W(Yi(), Li), t = W(Yi(), Fi), r = W(Xi(), Li), n = W(Xi(), Fi), i = Eu().pipe(ii(jn));
  return Su().pipe(ii(Tu)).subscribe(
    H(
      Ni(
        (u, s) => W(
          r(u),
...
*/
var Se, Nn, je, Dt, At, dr, Po, Ht, Or, Ro, Et, at, Do, Ao = function() {
  return Se || typeof window < "u" && (Se = window.gsap) && Se.registerPlugin && Se;
}, No = 1, lr = [], A = [], _t = [], kr = Date.now, In = function(t, r) {
  return r;
}, Mu = function() {
  var t = Or.core, r = t.bridge || {}, n = t._scrollers, i = t._proxies;
  n.push.apply(n, A), i.push.apply(i, _t), A = n, _t = i, In = function(u, s) {
    return r[u](s);
  };
}, zt = function(t, r) {
...
}, Vr = "scrollLeft", Wr = "scrollTop", zn = function() {
  return Et && Et.isPressed || A.cache++;
}, fn = function(t, r) {
  var n = function i(o) {
    if (o || o === 0) {
      No && (je.history.scrollRestoration = "manual");
      var u = Et && Et.isPressed;
      o = i.v = Math.round(o) || (Et && Et.iOS ? 1 : 0), t(o), i.cacheID = A.cache, u && In("ss", o);
    } else
      (r || A.cache !== i.cacheID || In("ref")) && (i.cacheID = A.cache, i.v = t());
    return i.v + i.offset;
  };
  ...
  a: "x",
  sc: fn(function(e) {
    return arguments.length ? je.scrollTo(e, fe.sc()) : je.pageXOffset || Dt[Vr] || At[Vr] || dr[Vr] || 0;
  })
}, fe = {
  s: Wr,
  p: "top",
  ...
  op: Le,
  sc: fn(function(e) {
    return arguments.length ? je.scrollTo(Le.sc(), e) : je.pageYOffset || Dt[Wr] || At[Wr] || dr[Wr] || 0;
  })
}, We = function(t) {
  return Se.utils.toArray(t)[0] || (typeof t == "string" && Se.config().nullTargetWarn !== !1 ? console.warn("Element not found:", t) : null);
}, Lt = function(t, r) {
  var n = r.s, i = r.sc;
  Pr(t) && (t = Dt.scrollingElement || At);
  var o = A.indexOf(t), u = i === fe.sc ? 1 : 2;
  !~o && (o = A.push(t) - 1), A[o + u] || t.addEventListener("scroll", zn);
  ...
  Or = Se.core.globals().ScrollTrigger, Or && Or.core && Mu();
}, zo = function(t) {
  return Se = t || Ao(), Se && typeof document < "u" && document.body && (je = window, Dt = document, At = Dt.documentElement, dr = Dt.body, Ro = [je, Dt, At, dr], Se.utils.clamp, Do = Se.core.context || function() {
  }, Ht = "onpointerenter" in dr ? "pointer" : "mouse", Po = ue.isTouch = je.matchMedia && je.matchMedia("(hover: none), (pointer: coarse)").matches ? 1 : "ontouchstart" in je || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 ? 2 : 0, at = ue.eventTypes = ("ontouchstart" in At ? "touchstart,touchmove,touchcancel,touchend" : "onpointerdown" in At ? "pointerdown,pointermove,pointercancel,pointerup" : "mousedown,mousemove,mouseup,mouseup").split(","), setTimeout(function() {
    return No = 0;
  }, 500), Io(), Nn = 1), Nn;
};
Le.op = fe;
...
var ue = /* @__PURE__ */ function() {
  ...
  return t.init = function(n) {
    Nn || zo(Se) || console.warn("Please gsap.registerPlugin(Observer)"), Or || Io();
    var i = n.tolerance, o = n.dragMinimum, u = n.type, s = n.target, f = n.lineHeight, p = n.debounce, m = n.preventDefault, d = n.onStop, h = n.onStopDelay, c = n.ignore, _ = n.wheelSpeed, z = n.event, $ = n.onDragStart, P = n.onDragEnd, K = n.onDrag, B = n.onPress, M = n.onRelease, L = n.onRight, w = n.onLeft, b = n.onUp, U = n.onDown, de = n.onChangeX, x = n.onChangeY, ae = n.onChange, T = n.onToggleX, Qe = n.onToggleY, Y = n.onHover, ge = n.onHoverEnd, Oe = n.onMove, X = n.ignoreCheck, ce = n.isNormalizer, ie = n.onGestureStart, a = n.onGestureEnd, le = n.onWheel, Vt = n.onEnable, xt = n.onDisable, Ke = n.onClick, Mt = n.scrollSpeed, G = n.capture, Te = n.allowClicks, ke = n.lockAxis, pr = n.onLockAxis;
    this.target = s = We(s) || At, this.vars = n, c && (c = Se.utils.toArray(c)), i = i || 1e-9, o = o || 0, _ = _ || 1, Mt = Mt || 1, u = u || "wheel,touch,pointer", p = p !== !1, f || (f = parseFloat(je.getComputedStyle(dr).lineHeight) || 22);
    var $e, Ze, N, he, Ye, dt, Pe, l = this, vt = 0, q = 0, Ct = Lt(s, Le), Ot = Lt(s, fe), rr = Ct(), Re = Ot(), mr = ~u.indexOf("touch") && !~u.indexOf("pointer") && at[0] === "pointerdown", kt = Pr(s), te = s.ownerDocument || Dt, Xe = [0, 0, 0], De = [0, 0, 0], _r = 0, Ae = function() {
      return _r = kr();
    }, gt = function(E, g) {
      ...
      var E = l.deltaX = Ui(Xe), g = l.deltaY = Ui(De), y = Math.abs(E) >= i, S = Math.abs(g) >= i;
      ...
      if (!gt(E, 1)) {
        ...
        l.x = g, l.y = y, (pe || Math.abs(l.startX - g) >= o || Math.abs(l.startY - y) >= o) && (K && (N = !0), pe || (l.isDragging = !0), Wt(S, k), pe || $ && $(l));
      }
    }, D = l.onPress = function(C) {
      gt(C, 1) || C && C.button || (l.axis = Pe = null, Ze.pause(), l.isPressed = !0, C = Er(C), vt = q = 0, l.startX = l.x = C.clientX, l.startY = l.y = C.clientY, l._vx.reset(), l._vy.reset(), Ve(ce ? s : te, at[1], $t, m, !0), l.deltaX = l.deltaY = 0, B && B(l));
    ...
    Ze = l._dc = Se.delayedCall(h || 0.25, vr).pause(), l.deltaX = l.deltaY = 0, l._vx = Bn(0, 50, !0), l._vy = Bn(0, 50, !0), l.scrollX = Ct, l.scrollY = Ot, l.isDragging = l.isGesturing = l.isPressed = !1, Do(this), l.enable = function(C) {
      return l.isEnabled || (Ve(kt ? te : s, "scroll", zn), u.indexOf("scroll") >= 0 && Ve(kt ? te : s, "scroll", Je, m, G), u.indexOf("wheel") >= 0 && Ve(s, "wheel", ut, m, G), (u.indexOf("touch") >= 0 && Po || u.indexOf("pointer") >= 0) && (Ve(s, at[0], D, m, G), Ve(te, at[2], bt), Ve(te, at[3], bt), Te && Ve(s, "click", Ae, !1, !0), Ke && Ve(s, "click", br), ie && Ve(te, "gesturestart", ot), a && Ve(te, "gestureend", st), Y && Ve(s, Ht + "enter", ir), ge && Ve(s, Ht + "leave", wt), Oe && Ve(s, Ht + "move", Yt)), l.isEnabled = !0, C && C.type && D(C), Vt && Vt(l)), l;
    }, l.disable = function() {
      l.isEnabled && (lr.filter(function(C) {
        return C !== l && Pr(C.target);
      }).length || Ie(kt ? te : s, "scroll", zn), l.isPressed && (l._vx.reset(), l._vy.reset(), Ie(ce ? s : te, at[1], $t, !0)), Ie(kt ? te : s, "scroll", Je, G), Ie(s, "wheel", ut, G), Ie(s, at[0], D, G), Ie(te, at[2], bt), Ie(te, at[3], bt), Ie(s, "click", Ae, !0), Ie(s, "click", br), Ie(te, "gesturestart", ot), Ie(te, "gestureend", st), Ie(s, Ht + "enter", ir), Ie(s, Ht + "leave", wt), Ie(s, Ht + "move", Yt), l.isEnabled = l.isPressed = l.isDragging = !1, xt && xt(l));
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var v, ar, I, j, lt, ee, Bo, dn, gn, fr, Zr, $r, Me, yn, Ln, ze, Gi, qi, cr, Lo, Mn, Fo, Ue, Vo, Wo, $o, Rt, Fn, Qn, Cn, Yr = 1, Be = Date.now, On = Be(), nt = 0, Tr = 0, Cu = function e() {
  ...
  return !r || ~_t.indexOf(t) ? Ho(t) : function() {
    return on;
  };
}, Nt = function(t, r) {
  var n = r.s, i = r.d2, o = r.d, u = r.a;
  return Math.max(0, (n = "scroll" + i) && (u = zt(t, n)) ? u() - Ho(t)()[o] : Jt(t) ? (lt[n] || ee[n]) - (I["inner" + i] || lt["client" + i] || ee["client" + i]) : t[n] - t["offset" + i]);
}, Xr = function(t, r) {
...
}, sr = Math.abs, Uo = "left", Go = "top", Kn = "right", Zn = "bottom", jt = "width", Qt = "height", Rr = "Right", Dr = "Left", Ar = "Top", Nr = "Bottom", ne = "padding", et = "margin", hr = "Width", Jn = "Height", Ee = "px", ft = function(t) {
  ...
  var n = r && ft(t)[Ln] !== "matrix(1, 0, 0, 1, 0, 0)" && v.to(t, {
    x: 0,
    y: 0,
    xPercent: 0,
    yPercent: 0,
  ...
  var p = o.startColor, m = o.endColor, d = o.fontSize, h = o.indent, c = o.fontWeight, _ = j.createElement("div"), z = Jt(n) || zt(n, "pinType") === "fixed", $ = t.indexOf("scroller") !== -1, P = z ? ee : n, K = t.indexOf("start") !== -1, B = K ? p : m, M = "border-color:" + B + ";font-size:" + d + ";color:" + B + ";font-weight:" + c + ";pointer-events:none;white-space:nowrap;font-family:sans-serif,Arial;z-index:1000;padding:4px 8px;border-width:0;border-style:solid;";
  return M += "position:" + (($ || f) && z ? "fixed;" : "absolute;"), ($ || f || !z) && (M += (i === fe ? Kn : Zn) + ":" + (u + parseFloat(h)) + "px;"), s && (M += "box-sizing:border-box;text-align:left;width:" + s.offsetWidth + "px;"), _._isStart = K, _.setAttribute("class", "gsap-marker-" + t + (r ? " marker-" + r : "")), _.style.cssText = M, _.innerText = r || r === 0 ? t + "-" + r : t, P.children[0] ? P.insertBefore(_, P.children[0]) : P.appendChild(_), _._offset = _["offset" + i.op.d2], tn(_, 0, i, K), _;
}, tn = function(t, r, n, i) {
  var o = {
    display: "block"
  ...
  $o = I.innerWidth, Wo = I.innerHeight;
}, Cr = function() {
  A.cache++, !Me && !Fo && !j.fullscreenElement && !j.webkitFullscreenElement && (!Vo || $o !== I.innerWidth || Math.abs(I.innerHeight - Wo) > I.innerHeight * 0.25) && dn.restart(!0);
}, er = {}, Au = [], jo = function e() {
  ...
  }), ct(t) && (I.history.scrollRestoration = Qn = t);
}, qe, Kt = 0, eo, Nu = function() {
  if (eo !== Kt) {
    var t = eo = Kt;
  ...
  Lo && O.sort(), r || ti(), A.forEach(function(i) {
  ...
  }), Ko(Qn, 1), dn.pause(), Kt++, qe = 2, Tt(2), R.forEach(function(i) {
    return Fe(i.vars.onRefresh) && i.vars.onRefresh(i);
  }), qe = O.isRefreshing = !1, tr("refresh");
}, $n = 0, rn = 1, Ir, Tt = function(t) {
  if (!qe || t === 2) {
    O.isUpdating = !0, Ir && Ir.update(0);
    var r = R.length, n = Be(), i = n - On >= 50, o = r && R[0].scroll();
    if (rn = $n > o ? -1 : 1, qe || ($n = o), i && (nt && !yn && n - nt > 200 && (nt = 0, tr("scrollEnd")), Zr = On, On = n), rn < 0) {
      for (ze = r; ze-- > 0; )
  ...
  zr = 0;
}, Yn = [Uo, Go, Zn, Kn, et + Nr, et + Rr, et + Ar, et + Dr, "display", "flexShrink", "float", "zIndex", "gridColumnStart", "gridColumnEnd", "gridRowStart", "gridRowEnd", "gridArea", "justifySelf", "alignSelf", "placeSelf", "order"], nn = Yn.concat([jt, Qt, "boxSizing", "max" + hr, "max" + Jn, "position", et, ne, ne + Ar, ne + Rr, ne + Nr, ne + Dr]), Iu = function(t, r, n) {
  gr(n);
  var i = t._gsap;
  if (i.spacerIsNative)
    gr(i.spacerState);
  ...
  left: 0,
  top: 0
}, to = function(t, r, n, i, o, u, s, f, p, m, d, h, c) {
...
}, Lu = /(webkit|moz|length|cssText|inset)/i, ro = function(t, r, n, i) {
  if (t.parentNode !== r) {
    var o = t.style, u, s;
    if (r === ee) {
      t._stOrig = o.cssText, s = ft(t);
      for (u in s)
        !+u && !Lu.test(u) && s[u] && typeof o[u] == "string" && u !== "0" && (o[u] = s[u]);
      o.top = n, o.left = i;
    } else
      o.cssText = t._stOrig;
  ...
  return t.init = function(n, i) {
    ...
    n = Ki(ct(n) || Mr(n) || n.nodeType ? {
      trigger: n
    } : n, Gr);
    var o = n, u = o.onUpdate, s = o.toggleClass, f = o.id, p = o.onToggle, m = o.onRefresh, d = o.scrub, h = o.trigger, c = o.pin, _ = o.pinSpacing, z = o.invalidateOnRefresh, $ = o.anticipatePin, P = o.onScrubComplete, K = o.onSnapComplete, B = o.once, M = o.snap, L = o.pinReparent, w = o.pinSpacer, b = o.containerAnimation, U = o.fastScrollEnd, de = o.preventOverlaps, x = n.horizontal || n.containerAnimation && n.horizontal !== !1 ? Le : fe, ae = !d && d !== 0, T = We(n.scroller || I), Qe = v.core.getCache(T), Y = Jt(T), ge = ("pinType" in n ? n.pinType : zt(T, "pinType") || Y && "fixed") === "fixed", Oe = [n.onEnter, n.onLeave, n.onEnterBack, n.onLeaveBack], X = ae && n.toggleActions.split(" "), ce = "markers" in n ? n.markers : Gr.markers, ie = Y ? 0 : parseFloat(ft(T)["border" + x.p2 + hr]) || 0, a = this, le = n.onRefreshInit && function() {
      return n.onRefreshInit(a);
    }, Vt = Ou(T, Y, x), xt = ku(T, Y), Ke = 0, Mt = 0, G = Lt(T, x), Te, ke, pr, $e, Ze, N, he, Ye, dt, Pe, l, vt, q, Ct, Ot, rr, Re, mr, kt, te, Xe, De, _r, Ae, gt, vr, Pt, nr, Wt, $t, D, bt, ot, st, Je, ut, Yt, ir, wt;
    if (Fn(a), a._dir = x, $ *= 45, a.scroller = T, a.scroll = b ? b.time.bind(b) : G, $e = G(), a.vars = n, i = i || n.animation, "refreshPriority" in n && (Lo = 1, n.refreshPriority === -9999 && (Ir = a)), Qe.tweenScroll = Qe.tweenScroll || {
      top: no(T, fe),
      left: no(T, Le)
    ...
    }, i && (i.vars.lazy = !1, i._initted || i.vars.immediateRender !== !1 && n.immediateRender !== !1 && i.duration() && i.render(0, !0, !0), a.animation = i.pause(), i.scrollTrigger = a, a.scrubDuration(d), D && D.resetTo && D.resetTo("totalProgress", 0), Wt = 0, f || (f = i.vars.id)), R.push(a), M && ((!Jr(M) || M.push) && (M = {
      snapTo: M
    }), "scrollBehavior" in ee.style && v.set(Y ? [ee, lt] : T, {
      scrollBehavior: "auto"
    }), A.forEach(function(g) {
      return Fe(g) && g.target === (Y ? j.scrollingElement || lt : T) && (g.smooth = !1);
    }), pr = Fe(M.snapTo) ? M.snapTo : M.snapTo === "labels" ? Ru(i) : M.snapTo === "labelsDirectional" ? Du(i) : M.directional !== !1 ? function(g, y) {
      return ei(M.snapTo)(g, Be() - Mt < 500 ? 0 : y.direction);
      ...
      if ((y || Math.abs(a.getVelocity()) < 10) && !S && !yn && Ke !== g) {
        var k = (g - N) / q, pe = i && !ae ? i.totalProgress() : k, V = y ? 0 : (pe - $t) / (Be() - Zr) * 1e3 || 0, Z = v.utils.clamp(-k, 1 - k, sr(V / 2) * V / 0.185), ye = k + (M.inertia === !1 ? 0 : Z), me = fr(0, 1, pr(ye, a)), oe = Math.round(N + me * q), J = M, He = J.onStart, Ne = J.onInterrupt, _e = J.onComplete;
        if (g <= he && g >= N && oe !== g) {
          if (S && !S._initted && S.data <= sr(oe - g))
            return;
          M.inertia === !1 && (Z = me - k), Te(oe, {
            duration: ot(sr(Math.max(sr(ye - pe), sr(me - pe)) * 0.185 / V / 0.05 || 0)),
            ease: M.ease || "power3",
            data: sr(oe - g),
    ...
    }).pause()), f && (Wn[f] = a), h = a.trigger = We(h || c), wt = h && h._gsap && h._gsap.stRevert, wt && (wt = wt(a)), c = c === !0 ? h : We(c), ct(s) && (s = {
      targets: h,
      className: s
      ...
      force3D: !0
    }), a.spacer = Re = ke.spacer, nr = ft(c), _r = nr[_ + x.os2], kt = v.getProperty(c), te = v.quickSetter(c, x.a, Ee), Rn(c, Re, nr), rr = jr(c)), ce) {
      vt = Jr(ce) ? Ki(ce, Zi) : Zi, Pe = qr("scroller-start", f, T, x, vt, 0), l = qr("scroller-end", f, T, x, vt, 0, Pe), mr = Pe["offset" + x.op.d2];
      var br = We(zt(T, "content") || T);
      Ye = this.markerStart = qr("start", f, br, x, vt, mr, 0, b), dt = this.markerEnd = qr("end", f, br, x, vt, mr, 0, b), b && (ir = v.quickSetter([Ye, dt], x.a, Ee)), !ge && !(_t.length && zt(T, "fixedMarkers") === !0) && (Pu(Y ? ee : T), v.set([Pe, l], {
        force3D: !0
    ...
    a.previous = function() {
      ...
      S !== a.isReverted && (S && (ut = Math.max(G(), a.scroll.rec || 0), Je = a.progress, Yt = i && i.progress()), Ye && [Ye, dt, Pe, l].forEach(function(pe) {
        return pe.style.display = S ? "none" : "block";
      }), S && (Me = a, a.update(S)), c && (!L || !a.isActive) && (S ? Iu(c, Re, Ct) : Rn(c, Re, ft(c), Ae)), S || a.update(S), Me = k, a.isReverted = S);
      ...
      if (!((Me || !a.enabled) && !y)) {
        ...
        for (var S = Vt(), k = xt(), pe = b ? b.duration() : Nt(T, x), V = q <= 0.01, Z = 0, ye = 0, me = n.end, oe = n.endTrigger || h, J = n.start || (n.start === 0 || !h ? 0 : c ? "0 0" : "0 100%"), He = a.pinnedContainer = n.pinnedContainer && We(n.pinnedContainer), Ne = h && Math.max(0, R.indexOf(a)) || 0, _e = Ne, re, xe, or, Xt, se, ve, ht, En, ri, wr, pt; _e--; )
        ...
        for (Fe(J) && (J = J(a)), N = to(J, h, S, x, G(), Ye, Pe, a, k, ie, ge, pe, b) || (c ? -1e-3 : 0), Fe(me) && (me = me(a)), ct(me) && !me.indexOf("+=") && (~me.indexOf(" ") ? me = (ct(J) ? J.split(" ")[0] : "") + me : (Z = en(me.substr(2), S), me = ct(J) ? J : (b ? v.utils.mapRange(0, b.duration(), b.scrollTrigger.start, b.scrollTrigger.end, N) : N) + Z, oe = h)), he = Math.max(N, to(me || (oe ? "100% 0" : pe), oe, S, x, G() + Z, dt, l, a, k, ie, ge, pe, b)) || -1e-3, q = he - N || (N -= 0.01) && 1e-3, Z = 0, _e = Ne; _e--; )
        ...
        if (N += Z, he += Z, V && (Je = v.utils.clamp(0, 1, v.utils.normalize(N, he, ut))), a._pinPush = ye, Ye && Z && (re = {}, re[x.a] = "+=" + Z, He && (re[x.p] = "-=" + G()), v.set([Ye, dt], re)), c)
          ...
          }, pt.style["overflow" + x.a.toUpperCase()] = "scroll"), Rn(c, Re, re), rr = jr(c), xe = yt(c, !0), En = ge && Lt(T, Xt ? Le : fe)(), _ && (Ae = [_ + x.os2, q + ye + Ee], Ae.t = Re, _e = _ === ne ? Vn(c, x) + q + ye : 0, _e && Ae.push(x.d, _e + Ee), gr(Ae), He && R.forEach(function(yr) {
            yr.pin === He && yr.vars.pinSpacing !== !1 && (yr._subPinOffset = !0);
          }), ge && G(ut)), ge && (se = {
            top: xe.top + (Xt ? or - N : En) + Ee,
            left: xe.left + (Xt ? En : or - N) + Ee,
            boxSizing: "border-box",
            position: "fixed"
          }, se[jt] = se["max" + hr] = Math.ceil(xe.width) + Ee, se[Qt] = se["max" + Jn] = Math.ceil(xe.height) + Ee, se[et] = se[et + Ar] = se[et + Rr] = se[et + Nr] = se[et + Dr] = "0", se[ne] = re[ne], se[ne + Ar] = re[ne + Ar], se[ne + Rr] = re[ne + Rr], se[ne + Nr] = re[ne + Nr], se[ne + Dr] = re[ne + Dr], Ot = Bu(Ct, se, L), qe && G(0)), i ? (ri = i._initted, Mn(1), i.render(i.duration(), !0, !0), De = kt(x.a) - Xe + q + ye, vr = Math.abs(q - De) > 1, ge && vr && Ot.splice(Ot.length - 2, 2), i.render(0, !0, !0), ri || i.invalidate(!0), i.parent || i.totalTime(i.totalTime()), Mn(0)) : De = q, pt && (pt.value ? pt.style["overflow" + x.a.toUpperCase()] = pt.value : pt.style.removeProperty("overflow-" + x.a));
        else if (h && G() && !b)
      ...
      if (!(b && !S && !g)) {
        var k = qe === !0 ? ut : a.scroll(), pe = g ? 0 : (k - N) / q, V = pe < 0 ? 0 : pe > 1 ? 1 : pe || 0, Z = a.progress, ye, me, oe, J, He, Ne, _e, re;
        if (y && (Ze = $e, $e = b ? G() : k, M && ($t = Wt, Wt = i && !ae ? i.totalProgress() : V)), $ && !V && c && !Me && !Yr && nt && N < k + (k - Ze) / (Be() - Zr) * $ && (V = 1e-4), V !== Z && a.enabled) {
          if (ye = a.isActive = !!V && V < 1, me = !!Z && Z < 1, Ne = ye !== me, He = Ne || !!V != !!Z, a.direction = V > Z ? 1 : -1, a.progress = V, He && !Me && (oe = V && !Z ? 0 : V === 1 ? 1 : Z === 1 ? 2 : 3, ae && (J = !Ne && X[oe + 1] !== "none" && X[oe + 1] || X[oe], re = i && (J === "complete" || J === "reset" || J in i))), de && (Ne || re) && (re || d || !i) && (Fe(de) ? de(a) : a.getTrailing(de).forEach(function(se) {
            return se.endAnimation();
          })), ae || (D && !Me && !Yr ? (D._dp._time - D._start !== D._time && D.render(D._dp._time - D._start), D.resetTo ? D.resetTo("totalProgress", V, i._tTime / i._tDur) : (D.vars.totalProgress = V, D.invalidate().restart())) : i && i.totalProgress(V, !!Me)), c) {
            if (g && _ && (Re.style[_ + x.os2] = _r), !ge)
              te(xr(Xe + De * V));
            else if (He) {
              if (_e = !g && V > Z && he + 1 > k && k + 1 >= Nt(T, x), L)
                if (!g && (ye || _e)) {
                  var xe = yt(c, !0), or = k - N;
                  ro(c, ee, xe.top + (x === fe ? or : 0) + Ee, xe.left + (x === fe ? 0 : or) + Ee);
                } else
                  ro(c, Re);
              gr(ye || _e ? Ot : rr), vr && V < 1 && ye || te(Xe + (V === 1 && !_e ? De : 0));
            }
          }
          M && !Te.tween && !Me && !Yr && st.restart(!0), s && (Ne || B && V && (V < 1 || !Cn)) && gn(s.targets).forEach(function(se) {
            return se.classList[ye || B ? "add" : "remove"](s.className);
          }), u && !ae && !g && u(a), He && !Me ? (ae && (re && (J === "complete" ? i.pause().totalProgress(1) : J === "reset" ? i.restart(!0).pause() : J === "restart" ? i.restart(!0) : i[J]()), u && u(a)), (Ne || !Cn) && (p && Ne && kn(a, p), Oe[oe] && kn(a, Oe[oe]), B && (V === 1 ? a.kill(!1, 1) : Oe[oe] = 0), Ne || (oe = V === 1 ? 1 : 3, Oe[oe] && kn(a, Oe[oe]))), U && !ye && Math.abs(a.getVelocity()) > (Mr(U) ? U : 2500) && (Sr(a.callbackAnimation), D ? D.progress(1) : Sr(i, J === "reverse" ? 1 : !V, 1))) : ae && u && !Me && u(a);
        }
        if (Pt) {
          var Xt = b ? k / b.duration() * (b._caScrollDist || 0) : k;
          gt(Xt + (Pe._isFlipped ? 1 : 0)), Pt(Xt);
        }
      ...
      a.disable(g, y), D && !y && D.kill(), f && delete Wn[f];
      var S = R.indexOf(a);
    ...
    return ar || (v = n || Xo(), Yo() && window.document && e.enable(), ar = Tr), ar;
    ...
    }), be(I, "wheel", ur), be(j, "scroll", ur), clearInterval($r), be(j, "touchcancel", mt), be(ee, "touchstart", mt), Hr(be, j, "pointerdown,touchstart,mousedown", ji), Hr(be, j, "pointerup,touchend,mouseup", Qi), dn.kill(), Xr(be);
    for (var o = 0; o < A.length; o += 3)
      Ur(be, A[o], A[o + 1]), Ur(be, A[o], A[o + 2]);
  }, e.enable = function() {
    if (I = window, j = document, lt = j.documentElement, ee = j.body, v && (gn = v.utils.toArray, fr = v.utils.clamp, Fn = v.core.context || mt, Mn = v.core.suppressOverwrites || mt, Qn = I.history.scrollRestoration || "auto", $n = I.pageYOffset, v.core.globals("ScrollTrigger", e), ee)) {
      Tr = 1, Cu(), ue.register(v), e.isTouch = ue.isTouch, Rt = ue.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent), we(I, "wheel", ur), Bo = [I, j, lt, ee], v.matchMedia ? (e.matchMedia = function(f) {
        ...
        return Pn(), Pn;
      })) : console.warn("Requires GSAP 3.11.0 or later"), Pn(), we(j, "scroll", ur);
      var n = ee.style, i = n.borderTopStyle, o = v.core.Animation.prototype, u, s;
      for (o.revert || Object.defineProperty(o, "revert", {
        value: function() {
          return this.time(-0.01, !0);
        }
      }), n.borderTopStyle = "solid", u = yt(ee), fe.m = Math.round(u.top + fe.sc()) || 0, Le.m = Math.round(u.left + Le.sc()) || 0, i ? n.borderTopStyle = i : n.removeProperty("border-top-style"), $r = setInterval(Ji, 250), v.delayedCall(0.5, function() {
        return Yr = 0;
      }), we(j, "touchcancel", mt), we(ee, "touchstart", mt), Hr(we, j, "pointerdown,touchstart,mousedown", ji), Hr(we, j, "pointerup,touchend,mouseup", Qi), Ln = v.utils.checkPrefix("transform"), nn.push(Ln), ar = Be(), dn = v.delayedCall(0.2, Gt).pause(), cr = [j, "visibilitychange", function() {
        var f = I.innerWidth, p = I.innerHeight;
        j.hidden ? (Gi = f, qi = p) : (Gi !== f || qi !== p) && Cr();
    ...
    i && clearInterval($r) || ($r = i) && setInterval(Ji, i), "ignoreMobileResize" in n && (Vo = e.isTouch === 1 && n.ignoreMobileResize), "autoRefreshEvents" in n && (Xr(be) || Xr(we, n.autoRefreshEvents || "none"), Fo = (n.autoRefreshEvents + "").indexOf("resize") === -1);
...
O.saveStyles = function(e) {
  return e ? gn(e).forEach(function(t) {
    if (t && t.style) {
      var r = Ge.indexOf(t);
      r >= 0 && Ge.splice(r, 5), Ge.push(t, t.style.cssText, t.getBBox && t.getAttribute("transform"), v.core.getCache(t), Fn());
    }
  }) : Ge;
};
...
var io = function(t, r, n, i) {
...
}, Vu = /(input|label|select|textarea)/i, oo, so = function(t) {
  var r = Vu.test(t.target.tagName);
  ...
  var r = t, n = r.normalizeScrollX, i = r.momentum, o = r.allowNestedScroll, u = r.onRelease, s, f, p = We(t.target) || lt, m = v.core.globals().ScrollSmoother, d = m && m.get(), h = Rt && (t.content && We(t.content) || d && t.content !== !1 && !d.smooth() && d.content()), c = Lt(p, fe), _ = Lt(p, Le), z = 1, $ = (ue.isTouch && I.visualViewport ? I.visualViewport.scale * I.visualViewport.width : I.outerWidth) / I.innerWidth, P = 0, K = Fe(i) ? function() {
    return i(s);
  } : function() {
    return i || 2.8;
  }, B, M, L = Jo(p, t.type, !0, o), w = function() {
    return M = !1;
  }, b = mt, U = mt, de = function() {
    f = Nt(p, fe), U = fr(Rt ? 1 : 0, f), n && (b = fr(0, Nt(p, Le))), B = Kt;
  }, x = function() {
  ...
  return h && v.set(h, {
    ...
    M = !1;
    var X = z;
    z = xr((I.visualViewport && I.visualViewport.scale || 1) / $), T.pause(), X !== z && Dn(p, z > 1.01 ? !0 : n ? !1 : "x"), Qe = _(), Y = c(), de(), B = Kt;
    ...
    if (c.offset && x(), !ce)
      ...
      A.cache++;
      var ie = K(), a, le;
      n && (a = _(), le = a + ie * 0.05 * -X.velocityX / 0.227, ie *= io(_, a, le, Nt(p, Le)), T.vars.scrollX = b(le)), a = c(), le = a + ie * 0.05 * -X.velocityY / 0.227, ie *= io(c, a, le, Nt(p, fe)), T.vars.scrollY = U(le), T.invalidate().duration(ie).play(0.01), (Rt && T.vars.scrollY >= f || a >= f - 1) && v.to({}, {
        onUpdate: Oe,
        duration: ie
      });
    }
    ...
    Dn(p, n ? !1 : "x"), O.addEventListener("refresh", Oe), we(I, "resize", Oe), c.smooth && (c.target.style.scrollBehavior = "auto", c.smooth = _.smooth = !1), L.enable();
  }, t.onDisable = function() {
    Dn(p, !0), be(I, "resize", Oe), O.removeEventListener("refresh", Oe), L.kill();
...
const { wrap: Yu, normalize: Xu, interpolate: Hu } = F.utils;
F.registerPlugin(O);
const Uu = { display: "inline-flex" }, Gu = "owow-marquee-outer", qu = "owow-marquee-inner";
function aa(e, t = {}, r = {}) {
  const n = W(
    t,
    Q,
    ...
    Br(H(Ft, Q)),
    pn
  ), o = it(() => O.create(i.scrollTriggerVars ?? {})), u = bn(e), s = H(
    tt(Zu(i.createDOM ?? !0)),
    tt(
      H(
        rt(Qu),
    ...
    Ut("create marquee instances", { config: i })
  );
  return wn(() => {
    const p = s(u);
    return () => W(
...
function ju(e, t, r) {
  ...
  return (o) => {
    ...
    ), s = F.quickSetter(o.dom.outerContainer, "x", "px"), f = H($u(1e3), s), p = Yu(0, -o.rects.innerRect.width), m = Xu(0, -o.rects.innerRect.width);
    let d, h, c, _, z, $, P, K;
    const B = it(
      () => F.ticker.add(() => {
        var w;
        switch (h = F.ticker.deltaRatio(), _ = Hu(
          _ ?? 0,
          r.getVelocity(),
          0.5 * h
...
function Ku({ target: e, innerContainer: t }) {
...
function Zu(e) {
  ...
  return (r) => {
    ...
    return W(
      ...
      Un(({ target: u, innerContainer: s, outerContainer: f }) => {
        fo(!!e, Boolean, () => {
...
function Ju(e, t = {}, r = {}) {
  ...
  return wn(() => {
    ...
    return () => {
      Ce.ticker.remove(h), Bt(d, (c) => c.destroy());
    };
  }, Q(r));
}
function la(e, t = {}, r = {}) {
  const n = W(
    ...
    bn,
    tt(ea(n.createDOM ?? !0, "owow-diorama-outer", "owow-diorama-inner")),
    tt(
      rt(
        (s) => Object.freeze({
          dom: s,
    ...
    const s = o(e), f = Ce.context(() => {
      W(
        ...
        Bt(({ dom: m, outerRect: d }) => {
          console.log(m.outer, d), Ce.set(m.outer, { height: d.height, overflow: "hidden" }), Ce.set(m.inner, { height: d.height * i });
        })
      );
    }), p = W(
      tt(
...
export {
  ...
  Lr as Motion,
  ko as Pointer,
  sa as SecondOrderDynamics,
  ts as TextClipReveal,
  la as createDiorama,
  aa as createMarquee,
  wn as createMotion,
  Ju as createParallax,
  ca as createTextClipReveal,
  oa as mousePosition,
  ua as physicsBasedMotion
};

...
function no(i, _, h) {
  ...
  _ = wi(_) || 0, In(h) && (ze = !!h.leading, pt = "maxWait" in h, b = pt ? to(wi(h.maxWait) || 0, _) : b, Ve = "trailing" in h ? !!h.trailing : Ve);
  function je(X) {
    var Se = D, at = T;
    return D = T = void 0, ge = X, he = i.apply(at, Se), he;
  }
  function Pt(X) {
    return ge = X, C = setTimeout(Ot, _), ze ? je(X) : he;
  }
  function Je(X) {
    var Se = X - W, at = X - ge, Ft = _ - Se;
    return pt ? ro(Ft, b - at) : Ft;
  }
  function Pe(X) {
    var Se = X - W, at = X - ge;
    return W === void 0 || Se >= _ || Se < 0 || pt && at >= b;
  }
  function Ot() {
    var X = Dn();
    if (Pe(X))
  ...
  function y() {
    ...
    if (D = arguments, T = this, W = X, Se) {
      if (C === void 0)
        return Pt(W);
      if (pt)
        return C = setTimeout(Ot, _), je(W);
    }
    return C === void 0 && (C = setTimeout(Ot, _)), he;
  }
  return y.cancel = xt, y.flush = ht, y;
}
function In(i) {
  var _ = typeof i;
  return !!i && (_ == "object" || _ == "function");
}
function io(i) {
  return !!i && typeof i == "object";
}
function oo(i) {
  return typeof i == "symbol" || io(i) && eo.call(i) == qi;
}
function wi(i) {
  if (typeof i == "number")
    return i;
  if (oo(i))
    return mi;
  if (In(i)) {
    var _ = typeof i.valueOf == "function" ? i.valueOf() : i;
    i = In(_) ? _ + "" : _;
  }
  if (typeof i != "string")
    return i === 0 ? i : +i;
  i = i.replace(Gi, "");
  var h = Ui.test(i);
  return h || Vi.test(i) ? ji(i.slice(2), h ? 2 : 8) : $i.test(i) ? mi : +i;
}
var so = no;
const ao = /* @__PURE__ */ Ni(so), yi = class {
  /**
   * @example
   ...
   */
  constructor(i, _ = {}) {
    this.meta = {}, this.subscriptions = [], this.reset = ao(
      () => {
        var h;
    ...
    }, this.observeMedia(Rn(_.watchMedia)), this.observeResize(Rn(_.shouldResetOnResize)), this.create = () => {
      var T;
      return this.context = Ie.context(), [
        Rn(_.enable) ?? !0,
  ...
  observeResize(i) {
    i && (this.motionResizeObserver = new lo(i), this.subscriptions.push(
      this.motionResizeObserver.observable.pipe(Bi(100)).subscribe(() => this.reset())
    ));
  }
};
let ln = yi;
...
class lo {
  constructor(_) {
    const [h, D] = [_].flat();
    this.element = typeof h == "string" ? document.querySelector(h) : h, this.axis = D, this.observable = new Hi((T) => {
  ...
  handleResize(_, h) {
    const D = _.find((ge) => ge.target === this.element);
    if (!D)
      return;
...
class xi extends ln {
  ...
  constructor() {
    super(
      (_) => {
        _.meta.observable = An(window, "mousemove"), _.subscriptions.push(
          _.meta.observable.subscribe((h) => {
...
$.inBack = (i, _ = Ln) => i * i * ((_ + 1) * i - _);
$.outBack = (i, _ = Ln) => {
  const h = i / 1 - 1;
  return h * h * ((_ + 1) * h + _) + 1;
};
$.inOutBack = (i, _ = Ln) => {
  const h = i * 2, D = h - 2, T = _ * 1.525;
  return h < 1 ? 0.5 * h * h * ((T + 1) * h - T) : 0.5 * (D * D * ((T + 1) * D + T) + 2);
};
$.inElastic = (i, _ = Fn) => {
  if (i === 0 || i === 1)
    return i;
  const D = i / 1 - 1, T = 1 - _, b = T / (2 * Math.PI) * Math.asin(1);
  return -(Math.pow(2, 10 * D) * Math.sin((D - b) * (2 * Math.PI) / T));
};
$.outElastic = (i, _ = Fn) => {
  if (i === 0 || i === 1)
    return i;
  const h = 1 - _, D = i * 2, T = h / (2 * Math.PI) * Math.asin(1);
  return Math.pow(2, -10 * D) * Math.sin((D - T) * (2 * Math.PI) / h) + 1;
};
$.inOutElastic = (i, _ = Fn) => {
  if (i === 0 || i === 1)
    return i;
  const h = 1 - _, D = i * 2, T = D - 1, b = h / (2 * Math.PI) * Math.asin(1);
...
(function(i, _) {
  (function(h, D) {
    ...
    */
     ...
     * @author: Jack Doyle, jack@greensock.com
    */
    var g, lr, L, Q, gt, ee, Hn, Hr, Nr, cr, Wr, qr, Oe, Gr, fn, Fe, Nn, Wn, ur, qn, dn, Gn, et, $n, Un, Vn, Bt, pn, hn, gn, $r = 1, Ye = Date.now, _n = Ye(), lt = 0, wr = 0, Mi = function s() {
      ...
      return g || Kn() && (g = window.gsap) && g.registerPlugin && g;
    }, Qt = function(e) {
      return !!~Hn.indexOf(e);
    }, Jn = function(e) {
      ...
      var t = n && vt(e)[fn] !== "matrix(1, 0, 0, 1, 0, 0)" && g.to(e, {
        x: 0,
        y: 0,
        xPercent: 0,
        yPercent: 0,
      ...
      e._isFlipped = r, o[t.a + "Percent"] = r ? -100 : 0, o[t.a] = r ? "1px" : 0, o["border" + c + dr] = 1, o["border" + a + dr] = 0, o[t.p] = n + "px", g.set(e, o);
    }, A = [], Sn = {}, Er, oi = function() {
      ...
      if (f && f.seek(0), xr(e))
        f && (e = g.utils.mapRange(f.scrollTrigger.start, f.scrollTrigger.end, 0, v, e)), a && tn(a, t, r, !0);
      else {
        Xe(n) && (n = n(p));
      ...
      function s(n, t) {
        lr || s.register(g) || console.warn("Please gsap.registerPlugin(ScrollTrigger)"), this.init(n, t);
      }
      var e = s.prototype;
      return e.init = function(t, r) {
        ...
        var o = t, c = o.onUpdate, a = o.toggleClass, p = o.id, M = o.onToggle, B = o.onRefresh, H = o.scrub, v = o.trigger, f = o.pin, m = o.pinSpacing, U = o.invalidateOnRefresh, ne = o.anticipatePin, q = o.onScrubComplete, Ke = o.onSnapComplete, te = o.once, F = o.snap, De = o.pinReparent, ie = o.pinSpacer, E = o.containerAnimation, Ze = o.fastScrollEnd, bt = o.preventOverlaps, P = t.horizontal || t.containerAnimation && t.horizontal !== !1 ? Le : fe, ke = !H && H !== 0, k = Qe(t.scroller || L), At = g.core.getCache(k), Ce = Qt(k), Be = ("pinType" in t ? t.pinType : St(k, "pinType") || Ce && "fixed") === "fixed", He = [t.onEnter, t.onLeave, t.onEnterBack, t.onLeaveBack], G = ke && t.toggleActions.split(" "), de = "markers" in t ? t.markers : Kr.markers, le = Ce ? 0 : parseFloat(vt(k)["border" + P.p2 + dr]) || 0, l = this, pe = t.onRefreshInit && function() {
        ...
        if (pn(l), l._dir = P, ne *= 45, l.scroller = k, l.scroll = E ? E.time.bind(E) : j, nt = j(), l.vars = t, r = r || t.animation, "refreshPriority" in t && (qn = 1, t.refreshPriority === -9999 && (Or = l)), At.tweenScroll = At.tweenScroll || {
          ...
          zt = xr(d) && d, zt ? z ? z.duration(d) : z = g.to(r, {
            ease: "expo",
            totalProgress: "+=0.001",
            duration: zt,
            paused: !0,
          ...
          snapTo: F
        }), "scrollBehavior" in ee.style && g.set(Ce ? [ee, gt] : k, {
          scrollBehavior: "auto"
        ...
        } : g.utils.snap(F.snapTo), mt = F.duration || {
          min: 0.1,
          max: 2
        }, mt = Vr(mt) ? cr(mt.min, mt.max) : cr(mt, mt), wt = g.delayedCall(F.delay || zt / 2 || 0.1, function() {
          var d = j(), w = Ye() - Wt < 500, S = Re.tween;
          if ((w || Math.abs(l.getVelocity()) < 10) && !S && !Gr && ut !== d) {
            var R = (d - Y) / K, me = r && !ke ? r.totalProgress() : R, N = w ? 0 : (me - or) / (Ye() - Wr) * 1e3 || 0, Z = g.utils.clamp(-R, 1 - R, fr(N / 2) * N / 0.185), Ee = R + (F.inertia === !1 ? 0 : Z), we = cr(0, 1, Dr(Ee, l)), ce = Math.round(Y + we * K), J = F, st = J.onStart, Ue = J.onInterrupt, ye = J.onComplete;
            if (d <= be && d >= Y && ce !== d) {
          ...
          targets: v,
          className: a
        }), f && (m === !1 || m === ct || (m = !m && f.parentNode && f.parentNode.style && vt(f.parentNode).display === "flex" ? !1 : re), l.pin = f, Ne = g.core.getCache(f), Ne.spacer ? qt = Ne.pinState : (ie && (ie = Qe(ie), ie && !ie.nodeType && (ie = ie.current || ie.nativeElement), Ne.spacerIsNative = !!ie, ie && (Ne.spacerState = on(ie))), Ne.spacer = qe = ie || Q.createElement("div"), qe.classList.add("pin-spacer"), p && qe.classList.add("pin-spacer-" + p), Ne.pinState = qt = on(f)), t.force3D !== !1 && g.set(f, {
          force3D: !0
        }), l.spacer = qe = Ne.spacer, _r = vt(f), Ar = _r[m + P.os2], $t = g.getProperty(f), oe = g.quickSetter(f, P.a, Me), En(f, qe, _r), gr = on(f)), de) {
          ...
          it = this.markerStart = en("start", p, zr, P, It, Rr, 0, E), Mt = this.markerEnd = en("end", p, zr, P, It, Rr, 0, E), E && (vr = g.quickSetter([it, Mt], P.a, Me)), !Be && !(X.length && St(k, "fixedMarkers") === !0) && (Ei(Ce ? ee : k), g.set([We, u], {
            force3D: !0
          }), kt = g.quickSetter(We, P.a, Me), Ut = g.quickSetter(u, P.a, Me));
        }
        if (E) {
        ...
        l.previous = function() {
          ...
          if (!((Oe || !l.enabled) && !w)) {
            ...
            if (Y += Z, be += Z, N && (dt = g.utils.clamp(0, 1, g.utils.normalize(Y, be, yt))), l._pinPush = Ee, it && Z && (se = {}, se[P.a] = "+=" + Z, st && (se[P.p] = "-=" + j()), g.set([it, Mt], se)), f)
            ...
            }), l.start = Y, l.end = be, nt = ft = rt ? yt : j(), !E && !rt && (nt < yt && j(yt), l.scroll.rec = 0), l.revert(!1, !0), wt && (ut = -1, l.isActive && j(Y + K * dt), wt.restart(!0)), Oe = 0, r && ke && (r._initted || sr) && r.progress() !== sr && r.progress(sr, !0).render(r.time(), !0, !0), (N || dt !== l.progress || E) && (r && !ke && r.totalProgress(E && Y < -1e-3 && !dt ? g.utils.normalize(Y, be, 0) : dt, !0), l.progress = (nt - Y) / K === dt ? 0 : dt), f && m && (qe._pinOffset = Math.round(l.progress * Ge)), z && z.invalidate(), B && !rt && B(l);
          }
        ...
        }, l.enable(!1, !1), Lt && Lt(l), !r || !r.add || K ? l.refresh() : g.delayedCall(0.01, function() {
          return Y || be || l.refresh();
        }) && (K = 0.01) && (Y = be = 0), f && Ri();
      }, s.register = function(t) {
        return lr || (g = t || Zn(), Kn() && window.document && s.enable(), lr = wr), lr;
        ...
        if (L = window, Q = document, gt = Q.documentElement, ee = Q.body, g && (Nr = g.utils.toArray, cr = g.utils.clamp, pn = g.core.context || Tt, dn = g.core.suppressOverwrites || Tt, hn = L.history.scrollRestoration || "auto", kn = L.pageYOffset, g.core.globals("ScrollTrigger", s), ee)) {
          wr = 1, Mi(), ae.register(g), s.isTouch = ae.isTouch, Bt = ae.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent), _e(L, "wheel", pr), Hn = [L, Q, gt, ee], g.matchMedia ? (s.matchMedia = function(p) {
            var M = g.matchMedia(), B;
            for (B in p)
              M.add(B, p[B]);
            return M;
          ...
          var t = ee.style, r = t.borderTopStyle, o = g.core.Animation.prototype, c, a;
          for (o.revert || Object.defineProperty(o, "revert", {
            value: function() {
              return this.time(-0.01, !0);
            }
          }), t.borderTopStyle = "solid", c = Dt(ee), fe.m = Math.round(c.top + fe.sc()) || 0, Le.m = Math.round(c.left + Le.sc()) || 0, r ? t.borderTopStyle = r : t.removeProperty("border-top-style"), qr = setInterval(oi, 250), g.delayedCall(0.5, function() {
            return $r = 0;
          }), _e(Q, "touchcancel", Tt), _e(ee, "touchstart", Tt), jr(_e, Q, "pointerdown,touchstart,mousedown", jn), jr(_e, Q, "pointerup,touchend,mouseup", Qn), fn = g.utils.checkPrefix("transform"), nn.push(fn), lr = Ye(), Hr = g.delayedCall(0.2, rr).pause(), ur = [Q, "visibilitychange", function() {
    ...
    I.version = "3.11.5", I.saveStyles = function(s) {
      return s ? Nr(s).forEach(function(e) {
        if (e && e.style) {
          var n = tt.indexOf(e);
          n >= 0 && tt.splice(n, 5), tt.push(e, e.style.cssText, e.getBBox && e.getAttribute("transform"), g.core.getCache(e), pn());
        }
      }) : tt;
      ...
      var n = [], t = {}, r = e.interval || 0.016, o = e.batchMax || 1e9, c = function(M, B) {
        var H = [], v = [], f = g.delayedCall(r, function() {
          B(H, v), H = [], v = [];
        }).pause();
        return function(m) {
    ...
    var hi = function(e, n, t, r) {
      ...
      var n = e.event, t = e.target, r = e.axis, o = (n.changedTouches ? n.changedTouches[0] : n).target, c = o._gsap || g.core.getCache(o), a = Ye(), p;
      ...
      var n = e, t = n.normalizeScrollX, r = n.momentum, o = n.allowNestedScroll, c = n.onRelease, a, p, M = Qe(e.target) || gt, B = g.core.globals().ScrollSmoother, H = B && B.get(), v = Bt && (e.content && Qe(e.content) || H && e.content !== !1 && !H.smooth() && H.content()), f = Xt(M, fe), m = Xt(M, Le), U = 1, ne = (ae.isTouch && L.visualViewport ? L.visualViewport.scale * L.visualViewport.width : L.outerWidth) / L.innerWidth, q = 0, Ke = Xe(r) ? function() {
        return r(a);
      } : function() {
        return r || 2.8;
      ...
      return v && g.set(v, {
        ...
        if (f.offset && P(), !de)
          ...
          y.cache++;
          var le = Ke(), l, pe;
          t && (l = m(), pe = l + le * 0.05 * -G.velocityX / 0.227, le *= hi(m, l, pe, Ht(M, Le)), k.vars.scrollX = E(pe)), l = f(), pe = l + le * 0.05 * -G.velocityY / 0.227, le *= hi(f, l, pe, Ht(M, fe)), k.vars.scrollY = Ze(pe), k.invalidate().duration(le).play(0.01), (Bt && k.vars.scrollY >= p || l >= p - 1) && g.to({}, {
            onUpdate: He,
            duration: le
          });
        }
      ...
      }, e.lockAxis = e.lockAxis !== !1, a = new ae(e), a.iOS = Bt, Bt && !f() && f(1), Bt && g.ticker.add(Tt), Be = a._dc, k = g.to(a, {
        ease: "power4",
        paused: !0,
        scrollX: t ? "+=0.1" : "+=0",
        scrollY: "+=0.1",
    ...
    }, Zn() && g.registerPlugin(I), h.ScrollTrigger = I, h.default = I, typeof window > "u" || window !== h ? Object.defineProperty(h, "__esModule", { value: !0 }) : delete window.default;
  });
})(zn, zn.exports);
var Si = zn.exports;
...
class Ti extends ln {
  ...
  set velocity(_) {
    this.meta.velocity = _;
  }
  get direction() {
    return this.meta.direction;
  }
  set direction(_) {
    this.meta.direction = _;
  }
  constructor(_, h = {}, D = {}) {
    super(
      (T) => {
        ...
        let b = null;
        typeof _ == "string" ? b = document.querySelector(_) : _ instanceof HTMLElement && (b = _);
